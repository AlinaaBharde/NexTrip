            ...
            <div className="mt-8 grid mb-8 border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 md:mb-12 md:grid-cols-2 bg-white dark:bg-gray-800">
                <figure className="flex flex-col items-center justify-center p-8 text-center bg-white border-b border-gray-200 rounded-t-lg md:rounded-t-none md:rounded-ss-lg md:border-e dark:bg-gray-800 dark:border-gray-700">
                    <blockquote className="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8 dark:text-gray-400">
                        <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Very easy to multiple plan trips!</h3>
                    ...
                    <figcaption className="flex items-center justify-center ">
                        ...
                        <div className="space-y-0.5 font-medium dark:text-white text-left rtl:text-right ms-3">
                            ...
                            <div className="text-sm text-gray-500 dark:text-gray-400 ">Travel youtuber</div>
                        </div>
                    </figcaption>
                </figure>
                <figure className="flex flex-col items-center justify-center p-8 text-center bg-white border-b border-gray-200 md:rounded-se-lg dark:bg-gray-800 dark:border-gray-700">
                    <blockquote className="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8 dark:text-gray-400">
                        <h3 className="text-lg font-semibold text-gray-900 dark:text-white">One of the best website for planning any vacation</h3>
                        <p className="my-4">Helped me trip my first vacation to Europe!"</p>
                    </blockquote>
                    <figcaption className="flex items-center justify-center ">
                        ...
                        <div className="space-y-0.5 font-medium dark:text-white text-left rtl:text-right ms-3">
                            ...
                            <div className="text-sm text-gray-500 dark:text-gray-400">Instagaram Influencer</div>
                        </div>
                    </figcaption>
                </figure>
                <figure className="flex flex-col items-center justify-center p-8 text-center bg-white border-b border-gray-200 md:rounded-es-lg md:border-b-0 md:border-e dark:bg-gray-800 dark:border-gray-700">
                    <blockquote className="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8 dark:text-gray-400">
                        <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Mindblowing user experience</h3>
                        <p className="my-4">Aesthetically, the well designed components are beautiful ."</p>
                    </blockquote>
                    <figcaption className="flex items-center justify-center ">
                        ...
                        <div className="space-y-0.5 font-medium dark:text-white text-left rtl:text-right ms-3">
                            <div>Jese Leos</div>
                            <div className="text-sm text-gray-500 dark:text-gray-400">Exchange student </div>
                        </div>
                    </figcaption>
                </figure>
                <figure className="flex flex-col items-center justify-center p-8 text-center bg-white border-gray-200 rounded-b-lg md:rounded-se-lg dark:bg-gray-800 dark:border-gray-700">
                    <blockquote className="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8 dark:text-gray-400">
                        <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Amazing trips and options</h3>
                        <p className="my-4">You have many options to choose from and decide."</p>
                    </blockquote>
                    <figcaption className="flex items-center justify-center ">
                        ...
                        <div className="space-y-0.5 font-medium dark:text-white text-left rtl:text-right ms-3">
                            ...
                            <div className="text-sm text-gray-500 dark:text-gray-400">Travel Blogger</div>
                        </div>
                    </figcaption>
                </figure>
            </div>
