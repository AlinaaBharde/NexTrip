  ...
  return (
    ...
    <div>
      ...
      <div id='cards' className='mt-8 flex flex-row justify-between space-x-6 font-Poppins'>
        <div className="  h-18 sm:h-27 md:h-36 lg:h-60 xl:h-80  hover:scale-110 transition-transform
...
flex flex-col justify-between ">
          ...
          <a className=" mb-4  inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg
     hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300
      dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        ...
        <div className="  h-18 sm:h-27 md:h-36 lg:h-60 xl:h-80 
...
flex flex-col justify-between ">
          ...
          <h5 className="mb-2 text-2xl font-bold tracking-tight text-[#fef9fc] ">Dubai,UAE</h5>
